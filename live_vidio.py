...
class_info = {
    "ARDUINO_NANO": {
        "info": "Information about class 1.",
        "google_link": "https://store-usa.arduino.cc/products/arduino-nano?selectedStore=us"
    },
    "DHT11": {
        "info": "Information about class 2.",
        "google_link": "https://store-usa.arduino.cc/products/arduino-nano?selectedStore=us"
    },
} 
...
def display_data():
    ...
    if len(data) > 0:
        headers = ['ID', 'Name', 'Quantity','Goggle Link']
